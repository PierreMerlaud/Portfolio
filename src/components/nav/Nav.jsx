...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <a href="#projets" onClick={() => setActiveNav("#projets")}className={activeNav === "#projets" ? "active" : ""}><HiComputerDesktop/></a>
      <a href="#contact" onClick={() => setActiveNav("#contact")}className={activeNav === "#contact" ? "active" : ""}><HiOutlineChatBubbleLeftRight/></a>
    </nav>
  )
}
